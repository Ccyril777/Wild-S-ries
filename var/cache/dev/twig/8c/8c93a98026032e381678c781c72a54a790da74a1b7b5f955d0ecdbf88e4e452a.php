        ...
        {% for episode in episodes %}
            <div>
                    <div>
                        ...
                        <p>{{ episode.summary }}</p>
                        <a class=\"mt-0\" href=\"{{ path('wild_episode', { 'id': season.id }) }}\">Détail de l'épisode</a>
                    </div>
                </div>
            </div>
        {% endfor %}
...
{% endblock %}
", "wild/seasons.html.twig", "/home/salazhar/Documents/Symfony/Wild Série/templates/wild/seasons.html.twig");
    }
}
